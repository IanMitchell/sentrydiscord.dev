...
export default function createMessage(event) {
  ...
  embed.setFooter(
    "Sentry",
    "https://cdn.glitch.global/06864aee-d950-488a-a19c-a2ece559e7fc/sentry-glyph-light-400x367.png?v=1659058577262",
  );
  ...
  return {
    username: "Sentry",
    avatar_url: `https://cdn.glitch.global/06864aee-d950-488a-a19c-a2ece559e7fc/sentry-glyph-dark-500x500%20(1).jpg?v=1659061407260`,
    embeds: [embed.toJSON()],
  };
}
